...
If we read more about the gene [Ttr](https://www.genecards.org/cgi-bin/carddisp.pl?gene=TTR), we can learn that it is "highly expressed in choroid plexus epithelial cells". If we were to continue looking at the top variable genes, we would hope to see more genes with experimental or celltype specific relevance.
