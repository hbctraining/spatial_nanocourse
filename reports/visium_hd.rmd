...
```{r normalize}
# SCTransform takes ~8 mins
# object_filt <- SCTransform(object_filt, assay = 'Spatial.016um')
...
object_filt <- FindClusters(object_filt, cluster.name = "seurat_cluster.sketched", resolution = .5)
...
SpatialDimPlot(object_filt, pt.size.factor = 8, cols = color_pal) 
